...
include("narrativetrace-soak")
include("narrativetrace-soak:shop")
include("narrativetrace-soak:notify")
project(":narrativetrace-soak:shop").projectDir = file("narrativetrace-soak/app/shop")
project(":narrativetrace-soak:notify").projectDir = file("narrativetrace-soak/app/notify")
