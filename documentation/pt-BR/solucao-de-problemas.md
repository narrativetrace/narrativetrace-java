...
O plugin do Gradle adiciona os dois automaticamente *(since 0.2.3)* — isso só importa para
uma configuração manual.

## Nenhum arquivo de saída de trace

**Causa:** a saída é gravada por padrão *(since 0.2.3)* em `build/narrativetrace`, então um
