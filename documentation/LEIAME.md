...
| [Formato de Trace Estrutural](pt-BR/formato-de-trace-estrutural.md) | O artefato `.nt` livre de valores por trás do relatório de deltas e dos traces de aprovação — a especificação do formato multiplataforma |
